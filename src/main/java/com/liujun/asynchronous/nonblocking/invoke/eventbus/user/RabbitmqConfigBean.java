...
public class RabbitmqConfigBean {
  ...
  /** 用户服务的监听 */
  @Autowired private UserEventProcess userEventProcess;
   ...
   * @return
   */
  @Bean("userSimpleMessageListenerContainer")
  public SimpleMessageListenerContainer simpleMessageListenerContainer(
    ...
    // 设置一个队列
    container.setQueueNames(RabbitmqConfig.getUserReqQueueName());
    container.setMessageListener(userEventProcess);
  ...
  public DirectExchange resourceDirectExchange() {
    return new DirectExchange(RabbitmqConfig.getUserReqExchangeName(), true, false);
  }
  ...
  public Queue resourceQueue() {
    ...
    return new Queue(RabbitmqConfig.getUserReqQueueName(), true);
  }
  ...
  public Binding resourceBind() {
    return BindingBuilder.bind(resourceQueue())
        ...
        .with(RabbitmqConfig.getUserReqQueueName());
  }
